...
import { QuantScreener } from '../components/screener/QuantScreener';
import { FactorExposures } from '../components/screener/FactorExposures';
import { PositionSizer } from '../components/screener/PositionSizer';
...
export function Screener() {
  ...
  const [view, setView] = useState<'stock' | 'quant'>('stock');
    ...
    <div className="p-4 space-y-3">
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-0.5">
          <button
            onClick={() => { setView('stock'); setSelectedTicker(null); }}
            className={`px-3 py-1.5 rounded text-xs font-medium transition-colors ${
              view === 'stock' ? 'bg-neutral-800 text-neutral-200' : 'text-neutral-500 hover:text-neutral-300'
            }`}
          >
            Stock Grader
          </button>
          <button
            ...
            className={`px-3 py-1.5 rounded text-xs font-medium transition-colors ${
              view === 'quant' ? 'bg-neutral-800 text-neutral-200' : 'text-neutral-500 hover:text-neutral-300'
            }`}
          >
            Quant Screen
          </button>
          ...
          <div className="lg:col-span-3">
            {!selectedTicker ? (
              ...
              <div className="space-y-3">
                ...
                <FactorExposures ticker={selectedTicker} />
                <PositionSizer ticker={selectedTicker} />
              </div>
            ) : null}
          </div>
