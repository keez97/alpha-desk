...
CACHE_TTL_QUOTE = int(os.getenv("CACHE_TTL_QUOTE", "120"))          # 2 min for live quotes
CACHE_TTL_HISTORY = int(os.getenv("CACHE_TTL_HISTORY", "3600"))     # 1 hour for daily bars
CACHE_TTL_MACRO = int(os.getenv("CACHE_TTL_MACRO", "1800"))         # 30 min for macro data
CACHE_TTL_FUNDAMENTALS = int(os.getenv("CACHE_TTL_FUNDAMENTALS", "14400"))  # 4 hours for fundamentals
CACHE_TTL_SECTOR = int(os.getenv("CACHE_TTL_SECTOR", "600"))        # 10 min for sector data
